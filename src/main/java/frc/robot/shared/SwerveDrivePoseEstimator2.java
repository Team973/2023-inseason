 ...
 */
public class SwerveDrivePoseEstimator2 {
   ...
   * @param timestampSeconds The timestamp of the vision measurement in seconds. Note that if you
   *     don't use your own time source by calling {@link
   *     SwerveDrivePoseEstimator2#updateWithTime(double, Rotation2d, Rotation2d, Rotation2d,
   *     SwerveModulePosition[])}, then you must use a timestamp with an epoch since FPGA startup
   *     (i.e., the epoch of this timestamp is the same epoch as {@link
  ...
  public Pose2d update(
    ...
    return updateWithTime(
        MathSharedStore.getTimestamp(), gyroAngle, gyroPitch, gyroRoll, modulePositions);
  }
