...
public final class RobotInfo {
    ...
    public static class ElevatorInfo {
        ...
        public static final int FOLLOWER_FX_ID = 2;
        public static final int BOTTOM_HALL_SENSOR_ID = 3;
        public static final int TOP_HALL_SENSOR_ID = 4;
    }
    ...
    public static class DriveInfo {
        ...
        public static final double FRONT_LEFT_MODULE_STEER_OFFSET = 237.04;
        ...
        public static final double DRIVE_GEAR_RATIO = 1 / ((12.0 / 42.0) * (28.0 / 18.0) * (15.0 / 45.0)); // 6.75:1
        ...
        public static final double MAX_VELOCITY_METERS_PER_SECOND = 6380.0 / 60.0 / DRIVE_GEAR_RATIO
                * WHEEL_DIAMETER_METERS * Math.PI;

        public static final double MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND = 11.5;

        public static final SwerveModuleConfig FRONT_LEFT_CONSTANTS = new SwerveModuleConfig(
                FRONT_LEFT_MODULE_DRIVE_MOTOR,
                FRONT_LEFT_MODULE_STEER_MOTOR,
                FRONT_LEFT_MODULE_STEER_ENCODER,
                FRONT_LEFT_MODULE_STEER_OFFSET);
        public static final SwerveModuleConfig FRONT_RIGHT_CONSTANTS = new SwerveModuleConfig(
                FRONT_RIGHT_MODULE_DRIVE_MOTOR,
                FRONT_RIGHT_MODULE_STEER_MOTOR,
                FRONT_RIGHT_MODULE_STEER_ENCODER,
                FRONT_RIGHT_MODULE_STEER_OFFSET);
        public static final SwerveModuleConfig BACK_LEFT_CONSTANTS = new SwerveModuleConfig(
                BACK_LEFT_MODULE_DRIVE_MOTOR,
                BACK_LEFT_MODULE_STEER_MOTOR,
                BACK_LEFT_MODULE_STEER_ENCODER,
                BACK_LEFT_MODULE_STEER_OFFSET);
        public static final SwerveModuleConfig BACK_RIGHT_CONSTANTS = new SwerveModuleConfig(
