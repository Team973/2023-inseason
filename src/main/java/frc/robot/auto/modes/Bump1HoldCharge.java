...
public class Bump1HoldCharge extends SequentialCommand {
  public Bump1HoldCharge(Drive drive, Superstructure superstructure) {
    super(
        ...
        new ConcurrentCommand(
            new PathPlannerTrajectoryCommand(
                drive, TrajectoryManager.Bump1HoldCharge.getPathSegment(0)),
        ...
        // Balance
        new PathPlannerTrajectoryCommand(
            drive, false, TrajectoryManager.Bump1HoldCharge.getPathSegment(1)),
