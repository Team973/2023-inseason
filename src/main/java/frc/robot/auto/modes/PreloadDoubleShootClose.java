...
public class PreloadDoubleShootClose extends SequentialCommand {

  public PreloadDoubleShootClose(Drive drive, Claw claw, Elevator elevator, Wrist wrist) {
    super(
        ...
        new ConcurrentCommand(
            ...
            new PathPlannerTrajectoryCommand(
                drive,
                TrajectoryManager.getPathSegment(TrajectoryManager.PreloadDoubleShootClose, 0))),
        new ConcurrentCommand(
        ...
        new ConcurrentCommand(
            ...
            new PathPlannerTrajectoryCommand(
                drive,
                TrajectoryManager.getPathSegment(TrajectoryManager.PreloadDoubleShootClose, 1))),
        new ConcurrentCommand(
        ...
        new ConcurrentCommand(
            ...
            new PathPlannerTrajectoryCommand(
                drive,
                TrajectoryManager.getPathSegment(TrajectoryManager.PreloadDoubleShootClose, 2))),
        new ConcurrentCommand(
            new ElevatorPresetCommand(elevator, Elevator.Preset.Floor, 1000),
            new WristPresetCommand(wrist, WristPreset.Floor, 10.0, 1000),
            new IntakeCommand(claw, IntakeState.In, 2000)),
        new ConcurrentCommand(
            ...
            new PathPlannerTrajectoryCommand(
                drive,
                TrajectoryManager.getPathSegment(TrajectoryManager.PreloadDoubleShootClose, 3)),
            new ConcurrentCommand(
                new WristPresetCommand(wrist, WristPreset.Floor, 10.00, 1000),
                new IntakeCommand(claw, IntakeState.Out, 1000))));
  }
